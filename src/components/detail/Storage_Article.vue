<template>
  <div>
    <div>Storage_Article_Detail : {{ articleId }}</div>

     <CommentChild ref="Storage_Article_Detail_Comment"></CommentChild>
...
export default {
  ...
  data() {
    return {
      ...
      record: {
        ...
        userid: 1,
        username: 'Alice',
        content: '文章详情jkljgklagjkljgklagjkljgkjkljgklagjkljgklagjjkljgklagjkljgklagkljgklagjkljgklagjkljgklagjkljgklaglagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklags',
        comments: ['xxxx', 'yyyy'],
        encourgeCount: 123,
        starCount: 123,
  ...
  methods: {
    ...
    //调用评论子组件
    showComment() {
      this.$refs.Storage_Article_Detail_Comment.open()
    },
  },
  mounted() {
    this.getUrlParam();
