<template>
  <div>
      <div>Product_Dynamic_Detail : {{ dynamicId }}</div>

        <CommentChild ref="Product_Dynamic_Detail_Comment"></CommentChild>
...
export default {
  ...
  data() {
    return {
      ...
      record: {
        ...
        userid: 1,
        username: 'Alice',
        content: '创作的动态--jkljgklagjkljgklagjkljgkjkljgklagjkljgklagjjkljgklagjkljgklagkljgklagjkljgklagjkljgklagjkljgklaglagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklagjkljgklags',
        comments: ['xxxx', 'yyyy'],
        encourgeCount: 123,
        starCount: 123,
  ...
  methods: {
    ...
    //调用评论子组件
    showComment() {
      this.$refs.Product_Dynamic_Detail_Comment.open()
    },
  },
  mounted() {
    this.getUrlParam();
